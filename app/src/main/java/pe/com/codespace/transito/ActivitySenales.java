...
public class ActivitySenales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar()!=null){
            ...
            getSupportActionBar().setTitle(getResources().getString(R.string.senales_transito_title));
        }

        //ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager);
        HackyViewPager viewPager = (HackyViewPager) findViewById(R.id.viewpager);
        FragmentPagerAdapter adapterViewPager = new AdapterFragments(getSupportFragmentManager(), this, MyValues.FRAGMENTS_SENALES);
        viewPager.setAdapter(adapterViewPager);

        // Agregar el adView
        AdView adView = (AdView)this.findViewById(R.id.adViewSenales);
